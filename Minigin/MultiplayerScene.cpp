...
void MultiplayerScene::Initialize(GameContext* gameContext)
{
	...
	//Pacwoman
	m_pPacwoman = new Pacwoman();
	m_pPacwoman->Create(m_pLevel, 1, {598, 279});
	AddChild(m_pPacwoman);
...
void MultiplayerScene::Update(GameContext* gameContext)
{
	UNREFERENCED_PARAMETER(gameContext);
